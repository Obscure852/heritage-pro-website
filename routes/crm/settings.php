...
Route::get('/settings/commercial', [CommercialSettingController::class, 'legacyIndex'])->name('settings.commercial');
...
Route::get('/settings/commercial/currencies/{currency}/edit', [CommercialSettingController::class, 'legacyEditCurrency'])->name('settings.commercial.edit-currency');
...
Route::get('/settings/imports/customers', [ImportController::class, 'customers'])->name('settings.imports.customers');
