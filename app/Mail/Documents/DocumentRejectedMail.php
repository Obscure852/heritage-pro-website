...
/**
 * Mailable sent to the document author when their document is rejected.
 */
class DocumentRejectedMail extends Mailable implements ShouldQueue {
    ...
    /** @var string Name of the reviewer who rejected */
    public string $reviewerName;

    /** @var string Rejection comments from the reviewer */
    ...
    public function build() {
        return $this->subject("Document Rejected: {$this->documentTitle}")
                    ->view('emails.documents.rejected');
    }
