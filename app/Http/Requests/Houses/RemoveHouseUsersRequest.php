...
class RemoveHouseUsersRequest extends FormRequest
{
    ...
    {
        return [
            'users.required' => 'No users were selected for removal. Please select at least one user.',
            'users.array' => 'The selected users payload is invalid.',
            'users.min' => 'No users were selected for removal. Please select at least one user.',
