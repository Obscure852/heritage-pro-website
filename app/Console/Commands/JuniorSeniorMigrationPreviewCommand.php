...
class JuniorSeniorMigrationPreviewCommand extends Command
{
    protected $signature = 'junior-senior:migration:preview';

    protected $description = 'Preview JUNIOR_SENIOR migration readiness for the current installation.';
    ...
    public function handle(): int
    {
        ...
        $this->info('JUNIOR_SENIOR migration readiness preview');
