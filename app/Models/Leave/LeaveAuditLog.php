...
/**
 * Model for leave audit logs.
 *
 * Records all changes to leave requests and balances for auditing purposes.
 * Uses polymorphic relationship to track changes across different leave models.
 *
 * @property int $id
...
class LeaveAuditLog extends Model
{
    ...
    /**
     * Leave request approved action.
     */
    const ACTION_APPROVE = 'approve';

    /**
     * Leave request rejected action.
     */
    const ACTION_REJECT = 'reject';

    /**
     * Leave request cancelled action.
     */
    const ACTION_CANCEL = 'cancel';

    /**
     * Balance manually adjusted action.
     */
    const ACTION_ADJUST = 'adjust';

    /**
     * Balance allocated (annual entitlement) action.
     */
    const ACTION_ALLOCATE = 'allocate';

    /**
     * Balance accrued (monthly increment) action.
     */
    const ACTION_ACCRUE = 'accrue';

    /**
     * Balance carried over from previous year action.
     */
    ...
    public static function actions(): array
    {
        return [
            ...
            self::ACTION_ADJUST => 'Adjusted',
            self::ACTION_ALLOCATE => 'Allocated',
            self::ACTION_ACCRUE => 'Accrued',
