...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('title') Most Borrowed Books @endslot
    @endcomponent
    ...
    <div class="library-container">
        <div class="library-header">
            <div class="row align-items-center">
                <div class="col-md-5">
                    <h3 style="margin:0;">Most Borrowed Books</h3>
                    ...
                    <div class="row text-center">
                        <div class="col">
                            <div class="stat-item">
                                ...
                                <small class="opacity-75">Books Listed</small>
                            </div>
                        </div>
                        <div class="col">
                            <div class="stat-item">
                                <h4 class="mb-0 fw-bold text-white">{{ $records->sum('checkout_count') }}</h4>
        ...
        <div class="library-body">
            ...
            <div class="filter-section">
                <form method="GET" action="{{ route('library.reports.most-borrowed') }}">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="{{ route('library.reports.most-borrowed.export', request()->query()) }}" class="btn-export w-100 text-center"><i class="fas fa-file-excel"></i> Export</a>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="summary-stats">
                <div class="summary-stat">
                    ...
                    <div class="stat-desc">Books Listed</div>
                </div>
                <div class="summary-stat">
                    <div class="stat-number">{{ $records->sum('checkout_count') }}</div>
                    <div class="stat-desc">Total Checkouts</div>
                </div>
                <div class="summary-stat">
                    <div class="stat-number">{{ $records->sum('unique_borrowers') }}</div>
                    <div class="stat-desc">Total Unique Borrowers</div>
                </div>
            </div>
                    ...
                    <table class="table table-striped table-hover mb-0">
                        <thead>
                            <tr>
                                ...
                                <th>Category</th>
                                <th>Grade</th>
                                <th style="text-align: right;">Checkouts</th>
                                <th style="text-align: right;">Unique Borrowers</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($records as $record)
                                <tr>
                                    ...
                                    <td style="text-align: right; font-weight: 600;">{{ $record->checkout_count }}</td>
                                    <td style="text-align: right;">{{ $record->unique_borrowers }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
            ...
            @else
                <div class="empty-state">
                    <i class="bx bx-trending-up d-block"></i>
                    <h5>No Checkout Data</h5>
                    <p>No books were checked out during this period.</p>
                </div>
            @endif
        </div>
    </div>
