...
@section('title', $crmRequest->title . ' - Edit Sales Request')
@section('crm_heading', $crmRequest->title)
@section('crm_subheading', 'Update this lead-stage sales request on its own dedicated sales form.')
...
@section('content')
    <div class="crm-stack">
        ...
        @include('crm.requests._attachments', [
            ...
            'subtitle' => 'Open or remove PDF and DOCX files already attached to this sales request.',
        ])
    </div>
@endsection
