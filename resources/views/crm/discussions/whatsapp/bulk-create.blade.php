...
@section('crm_subheading', 'Create a WhatsApp bulk campaign on its own page with a dedicated audience snapshot.')
...
@section('content')
    ...
    @include('crm.discussions.partials.external-bulk-page', [
        'action' => route('crm.discussions.whatsapp.bulk.store'),
