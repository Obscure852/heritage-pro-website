...
@section('content')
    ...
    <div class="form-container">
        <div class="page-header">
            <h1 class="page-title">Edit Discount Type</h1>
        </div>

        <div class="help-text">
            <div class="help-title">Update Discount Type Information</div>
            <div class="help-content">
                Modify the discount type details below. Changes to the percentage will affect future fee
                calculations for students with this discount assigned. Be cautious when deactivating
                a discount type that is currently assigned to students.
            </div>
        </div>

        <form class="needs-validation" method="POST" action="{{ route('fees.setup.discount-types.update', $discountType->id) }}" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('code', $discountType->code) }}"
                        maxlength="20"
                        required>
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('name', $discountType->name) }}"
                        maxlength="100"
                        required>
            ...
            <div class="form-grid" style="margin-top: 16px;">
                <div class="form-group">
                    ...
                    <input type="number"
                        ...
                        value="{{ old('percentage', $discountType->percentage) }}"
                        min="0"
                        max="100"
                        step="0.01"
                        required>
                ...
                <div class="form-group">
                    ...
                    <select class="form-select @error('applies_to') is-invalid @enderror"
                        ...
                        @foreach ($appliesOptions as $value => $label)
                            <option value="{{ $value }}" {{ old('applies_to', $discountType->applies_to) == $value ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-grid" style="margin-top: 16px;">
                <div class="form-group full-width">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror"
                        ...
                        rows="3">{{ old('description', $discountType->description) }}</textarea>
                ...
                <div class="form-group">
                    <div class="form-check">
                        ...
                        <input type="checkbox"
                            ...
                            id="is_active"
                            value="1"
                            {{ old('is_active', $discountType->is_active) ? 'checked' : '' }}>
                        <div>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-primary btn-loading">
                    <span class="btn-text"><i class="fas fa-save"></i> Update Discount Type</span>
