...
@section('content')
    ...
    <div class="form-container">
        <div class="page-header">
            <h1 class="page-title">Create Fee Type</h1>
        </div>

        <div class="help-text">
            <div class="help-title">Fee Type Information</div>
            <div class="help-content">
                Define a new fee type with a unique code and name. Fee types categorize the different charges
                that can be applied to students. Optional fees can be selected by parents, while required fees
                are automatically applied to all students.
            </div>
        </div>

        <form class="needs-validation" method="POST" action="{{ route('fees.setup.types.store') }}" novalidate>
            @csrf
            ...
            <div class="form-grid" style="margin-top: 16px;">
                <div class="form-group">
                    ...
                    <select class="form-select @error('category') is-invalid @enderror"
                        ...
                        <option value="tuition" {{ old('category') == 'tuition' ? 'selected' : '' }}>Tuition</option>
                        <option value="boarding" {{ old('category') == 'boarding' ? 'selected' : '' }}>Boarding</option>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-primary btn-loading">
                    <span class="btn-text"><i class="fas fa-save"></i> Create Fee Type</span>
