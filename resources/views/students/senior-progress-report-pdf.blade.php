    ...
    <div class="container">
        ...
        @foreach ($termData as $termId => $data)
            @php
                ...
                // Create a lookup for best subjects
                $bestSubjectNames = collect($bestSubjects)->pluck('subject')->map(fn($s) => strtolower($s))->toArray();
            @endphp
                ...
                <table class="results-table">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 47%;">Teacher's Comments</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($termExams as $index => $test)
                            @php
                                ...
                                $isInBest6 = in_array(strtolower($subjectName), $bestSubjectNames);
                            @endphp
                ...
                <div class="term-summary">
                    <table class="term-summary-table">
                        <tr>
                            ...
                            <td>{{ $subjectCount }}</td>
                            <td class="summary-label">Best 6 Subjects Total Points:</td>
