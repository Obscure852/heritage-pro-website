                ...
                <table class="results-table">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 12%;">Possible Marks</th>
                            <th class="text-center" style="width: 12%;">Actual Marks</th>
                            <th class="text-center" style="width: 8%;">%</th>
                            <th class="text-center" style="width: 8%;">Grade</th>
                            <th style="width: 37%;">Teacher's Comments</th>
                        </tr>
                    </thead>
                    <tbody>
                ...
                <div class="term-summary">
                    <table class="term-summary-table">
                        <tr>
                            ...
                            <td>{{ $totalScore }} / {{ $totalOutOf }}</td>
                            <td class="summary-label">Average:</td>
                            <td>{{ $averagePercentage }}%</td>
                            <td class="summary-label">Overall Grade:</td>
                            <td>
                                @php
                                    $overallGradeValue = is_object($overallGrade) ? ($overallGrade->grade ?? '-') : ($overallGrade ?? '-');
                                    $gradeClass = match (strtoupper($overallGradeValue)) {
                                        'MERIT' => 'grade-merit',
                                        'A' => 'grade-a',
                                        'B' => 'grade-b',
                                        'C' => 'grade-c',
                                ...
                                @endphp
                                <span class="grade-badge {{ $gradeClass }}">{{ $overallGradeValue }}</span>
                            </td>
                        </tr>
                    </table>
                </div>
