    ...
    <div class="students-container">
        <div class="students-header">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h4 class="mb-1 text-white"><i class="fas fa-user-slash me-2"></i>Students Without Class</h4>
                    <p class="mb-0 opacity-75">Students enrolled but not assigned to any class</p>
                </div>
                <div class="col-md-6">
                    @php
                        $totalCount = $unallocatedStudents ? $unallocatedStudents->count() : 0;
                        $maleCount = $unallocatedStudents ? $unallocatedStudents->where('gender', 'M')->count() : 0;
                        $femaleCount = $unallocatedStudents ? $unallocatedStudents->where('gender', 'F')->count() : 0;
                    @endphp
        ...
        <div class="students-body">
            <div class="help-text">
                <div class="help-title">Class Assignment Required</div>
                <p class="help-content">
                    These students are enrolled in the current term but have not been assigned to any class.
                    You can safely delete them or assign them to appropriate classes first.
                </p>
            </div>

            @if ($unallocatedStudents && $unallocatedStudents->count() > 0)
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <span class="badge bg-warning text-dark">Total: {{ $unallocatedStudents->count() }}</span>
                                <span class="badge bg-success">All Safe to Delete</span>
                            </div>
                        </div>
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <h5 class="mt-3 text-success">All Students Have Classes</h5>
                    <p class="text-muted mb-0">All students in the current term have been properly assigned to classes.</p>
                </div>
            @endif
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateSelectAllCheckboxes() {
                let totalCheckboxes = $('.student-checkbox').length;
            ...
            $('#deleteSelectedStudents').click(function() {
                ...
                let confirmMessage =
                    `Are you sure you want to delete ${selectedIds.length} selected student${selectedIds.length > 1 ? 's' : ''} without class assignments? This action cannot be undone.`;
