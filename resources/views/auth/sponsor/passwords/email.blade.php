...
@section('title')
    Sponsor Reset Password | Heritage Pro School Management System
@endsection
    ...
    <div class="auth-page">
        <div class="reset-card">
            ...
            <div class="info-alert">
                ...
                <p>A password reset link will be sent to your registered sponsor email address.</p>
            </div>
            ...
            <form method="POST" action="{{ route('sponsor.password.email') }}">
                ...
                <div class="form-group">
                    <label class="form-label">Sponsor email address</label>
            ...
            <div class="back-to-login">
                Remember your password? <a href="{{ route('sponsor.login') }}">Sign in</a>
            </div>
        </div>
