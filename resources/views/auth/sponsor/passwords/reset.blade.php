...
@section('title')
    Sponsor Recover Password | Heritage School Management System
@endsection
                    ...
                    <div class="recovery-card animate__animated animate__fadeInUp">
                        <div class="recovery-form">
                            <div class="text-center">
                                ...
                                <p class="text-muted mt-2">Sponsor Password Reset</p>
                            </div>
                            ...
                            <form class="mt-4" method="POST" action="{{ route('sponsor.password.update') }}">
                                @csrf
                                <input type="hidden" name="token" value="{{ $token }}">

                                {{-- Email is typically read-only for a password reset --}}
                                <div class="mb-3">
                                    <label for="useremail" class="form-label">Sponsor Email</label>
                            ...
                            <div class="mt-4 text-center">
                                ...
                                <p class="text-muted mb-0">
                                    ...
                                    <a href="{{ route('sponsor.login') }}" class="fw-semibold">Sign In</a>
                                </p>
                            </div>
                        </div>
                    </div>
