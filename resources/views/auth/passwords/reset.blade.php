...
@section('title')
    Recover Password | Heritage School Management System
@endsection
                ...
                <div class="col-lg-8">
                    <div class="recovery-card animate__animated animate__fadeInUp">
                        <div class="recovery-form">
                            ...
                            <div class="mt-4 text-center">
                                <p class="text-muted mb-0">Remember your password? <a href="{{ url('login') }}"
                    ...
                    <div class="mt-4 text-center">
                        <p class="text-muted">
                            ...
                            </script> Heritage School. Crafted with <i class="fas fa-heart text-danger"></i>
                            by Platinum Developers
                        </p>
                    </div>
                </div>
            </div>
