        ...
        <div class="col-md-12">
            <div class="dropdown d-flex justify-content-end">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" onclick="openClassReportCards($('#classId').val()); return false;"
                        ...
                        @foreach ($tests as $test)
                            ...
                            <li>
                                <a class="dropdown-item"
                                    onclick="openCAAnalysis($('#classId').val(), {{ $test->sequence }}); return false;"
                    ...
                    <li><a class="dropdown-item" onclick="openExamAnalysis($('#classId').val()); return false;"
                            href="">Class Performance - End of Term (Exam)</a>
                    </li>
                    ...
                    @if (!$tests->isEmpty())
                        @foreach ($tests as $test)
                            ...
                            <li>
                                <a class="dropdown-item"
                                    onclick="openCAGradeAnalysis($('#classId').val(),{{ $test->sequence }}); return false;"
                    ...
                    <li>
                        <a class="dropdown-item" onclick="openOverallGradeAnalysisExam($('#classId').val()); return false;"
                        ...
                        @foreach ($tests as $test)
                            ...
                            <li>
                                <a class="dropdown-item"
                                    ...
                                    href="">Subjects Performance Analysis By House ({{ $test->sequence }})-
                                    {{ $startMonth }} to {{ $endMonth }} (CA)</a>
                            </li>
                        @endforeach
                    @endif
    ...
    @else
        <div class="col-md-12">
            <div class="dropdown d-flex justify-content-end">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        <a class="dropdown-item" onclick="openClassReportCardsPrimary($('#classId').val()); return false;"
                            href="">Class Report Cards By Term </a>
                    </li>
    ...
    <script>
        $(document).ready(function() {
            ...
            function storeInSession() {
                ...
                var storeSelectedClassUrl = "{{ route('assessment.store-selected-class') }}";
                $.ajax({
                    url: storeSelectedClassUrl,
                    type: 'POST',
                    data: {
                        assessment: selectedClassId,
                        _token: '{{ csrf_token() }}'
                    },
        ...
        function updateClassLists() {
            ...
            var baseUrl =
                "{{ route('assessment.class-lists', ['classId' => 'tempClassId', 'termId' => 'tempTermId']) }}";
        ...
        function openClassReportCards(classId) {
            try {
                ...
                var baseUrl2 = "{{ route('assessment.generate-grades-report-cards', ['classId' => 'tempClassId']) }}";
        ...
        function openCAAnalysis(klassId, sequenceId) {
            try {
                const sanitizedClassId = encodeURIComponent(klassId);
                const sanitizedSequenceId = encodeURIComponent(sequenceId);

                var baseUrl3 =
                    "{{ route('assessment.generateCAAnalysis', ['classId' => 'tempClassId', 'sequenceId' => 'tempSequenceId']) }}";
                var finalBase2 = baseUrl3.replace('tempClassId', sanitizedClassId).replace('tempSequenceId',
                    sanitizedSequenceId);
        ...
        function openCAHouseAnalysis(sequenceId) {
            try {
                const sanitizedSequenceId = encodeURIComponent(sequenceId);
                var baseUrl9 = "{{ route('assessment.ca-house-analysis', ['sequenceId' => 'tempSequenceId']) }}";
                var finalBase8 = baseUrl9.replace('tempSequenceId', sanitizedSequenceId);
        ...
        function openExamHousesOverallAnalysisSimple() {
            try {
                var baseUrl10 = "{{ route('assessment.exam-houses-overall-analysis-simple') }}";
        ...
        function openClassReportCardsPrimary(classId) {
            try {
                const sanitizedClassId = encodeURIComponent(classId);
