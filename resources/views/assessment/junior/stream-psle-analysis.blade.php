    ...
    <div class="container-fluid">
        <div class="row no-print mb-3">
            <div class="col-12 d-flex justify-content-end">
                <a href="{{ request()->fullUrlWithQuery(['export' => 'excel']) }}" class="text-muted me-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <h6> {{ $grade->name ?? '' }}
                    {{ $test ? (strtolower($test->type) === 'exam' ? 'End of Term' : 'End of ' . $test->name) : '' }}
                    Grade Analysis - Term {{ $term->term }},
                    {{ $term->year }}</h6>
                    ...
                    <table class="table table-sm table-bordered table-striped performance-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="total-row">{{ $eu_T_percentage }}</td>
            ...
            new Chart(performanceCtx, {
                ...
                options: {
                    ...
                    plugins: {
                        title: {
                            display: true,
                            text: '{{ $type }} Performance Distribution by Gender'
                        }
                    },
                    scales: {
                        y: {
            ...
            new Chart(comparisonCtx, {
                ...
                options: {
                    ...
                    plugins: {
                        title: {
                            display: true,
                            text: 'PSLE vs Current {{ $type }} Comparison'
                        }
                    },
                    scales: {
                        y: {
