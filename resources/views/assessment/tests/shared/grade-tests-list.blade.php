                                            ...
                                            <div class="card test-card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="test-info">
                                                        ...
                                                        Grade: {{ $test->subject?->grade?->name ?? $test->grade?->name }}
                                                    </p>
                                                    <p class="test-info">
                                                    ...
                                                    @if (!session('is_past_term'))
                                                        <div class="action-buttons">
                                                            ...
                                                            <button type="button" class="btn btn-sm btn-outline-secondary copy-test-btn"
                                                                ...
                                                                data-test-grade-id="{{ $test->subject?->grade_id ?? $test->grade_id }}"
...
@php
    $availableSubjectsData = collect($availableSubjects ?? collect())->map(function ($gradeSubject) {
        return [
            'id' => $gradeSubject->id,
            'name' => $gradeSubject->subject->name ?? null,
