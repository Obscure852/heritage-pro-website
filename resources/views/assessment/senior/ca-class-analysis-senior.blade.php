...
@section('title')
    Class List Analysis - {{ ucfirst($test->name ?? 'CA') }}
@endsection
...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('title')
            Class List Analysis - {{ $test->name ?? 'CA' }}
        @endslot
    @endcomponent
    ...
    <div class="row no-print">
        <div class="col-md-12 col-lg-12 d-flex justify-content-end">
            <a class="text-muted" href="{{ request()->fullUrlWithQuery(['export' => 'excel']) }}">
                <i style="font-size: 20px;color:margin-bottom:10px; margin-right:10px; cursor:pointer;" class="bx bx-download"
                    title="Print"></i>
            </a>
    ...
    <div class="row printable">
        <div class="col-12">
            <div style="" class="card">
                ...
                <div class="card-body">
                    <h6>{{ $className }} - JCE Subjects Grade Analysis</h6>
                    ...
                    <!-- Second Table: End of Month/Term Class Subjects Grade Analysis -->
                    @if ($type === 'CA')
                        <h6>{{ $className }} - End of {{ $test->name ?? 'Month' }} Class Subjects Grade Analysis</h6>
                    @else
                        <h6>{{ $className }} - End of Term Class Subjects Grade Analysis</h6>
                    @endif
                    ...
                    <!-- Third Table: Students' Detailed Analysis -->
                    @if ($type === 'CA')
                        <h6>{{ $className }} - End of {{ $test->name ?? 'Month' }} Class Subjects Grade Analysis</h6>
                    @else
                        <h6>{{ $className }} - End of Term Exam Class Subjects Analysis</h6>
                    @endif
