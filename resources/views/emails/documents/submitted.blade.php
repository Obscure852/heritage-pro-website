...
<head>
    <meta charset="UTF-8">
    <title>Document Submitted for Review</title>
    <style>
        body,
        table,
        td,
...
<body>
    <div class="email-container">
        ...
        <div class="email-header">
            <h1>Document Submitted for Review</h1>
        </div>

        <div class="email-content">
            <p>Hello,</p>

            <p>{{ $submitterName }} has submitted a document for your review. Please review it at your earliest convenience.</p>
