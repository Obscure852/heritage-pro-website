...
<body>
    <div class="email-container">
        ...
        <div class="email-content">
            ...
            <p>This is a reminder that your review deadline is approaching for the following document:</p>
            ...
            <table class="details-table">
                ...
                <tr>
                    ...
                    <td><span class="status-badge">{{ $daysRemaining }} day(s)</span></td>
                </tr>
            </table>

            <div class="urgency-box">
                <div class="label">Action Required</div>
                <div class="text">Please review the document before the deadline to ensure timely processing.</div>
            </div>

            <a href="{{ $documentUrl }}" class="action-button">Review Document</a>
        </div>
