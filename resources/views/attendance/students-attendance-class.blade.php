    ...
    <div class="report-container d-print-none">
        <div class="report-header">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <h3><i class="fas fa-file-alt me-2"></i>Attendance Report</h3>
                    <p>{{ $klass->name ?? 'Class' }} - {{ \Carbon\Carbon::createFromDate($year, $month, 1)->format('F Y') }}</p>
                </div>
        ...
        <div class="report-body">
            ...
            <h5 class="report-title"><i class="fas fa-calendar-check me-2"></i>Monthly Attendance Grid</h5>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h5>Attendance Report for {{ $klass->name }} -
                        {{ \Carbon\Carbon::createFromDate($year, $month, 1)->format('F Y') }}</h5>
                    @if (!empty($klass))
                        <div class="row mt-4">
                            <div class="col-12">
                                <div class="table-responsive">
