...
@section('content')
    ...
    <div class="settings-container">
        <div class="settings-header">
            <h3><i class="fas fa-building me-2"></i>Add New Department</h3>
        ...
        <div class="settings-body">
            <div class="help-text">
                ...
                <div class="help-content">
                    Departments help organize staff into functional groups. Assign a department head
                    and optional assistant to manage the department.
                </div>
            </div>

            <form action="{{ route('staff.add-department') }}" method="POST" id="departmentForm">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="name" id="department" class="form-control"
                                placeholder="e.g., Humanities, Sciences, Administration" required>
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" name="department_assistant" id="department_assistant">
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary btn-loading" id="submitBtn">
                        <span class="btn-text"><i class="fas fa-save"></i> Create Department</span>
