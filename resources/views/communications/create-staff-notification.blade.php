        ...
        <div class="col-12">
            <div class="admissions-container">
                <div class="admissions-header">
                    <h4>Create Staff Notification</h4>
                    <p>Send a notification to staff members</p>
                </div>
                <div class="admissions-body">
                    <div class="help-text">
                        <i class="fas fa-info-circle me-2"></i>
                        Create a notification for staff members. You can filter recipients by department or area of work, or send to all staff by checking "General".
                    </div>

                    <form class="needs-validation" method="post" action="{{ route('notifications.store') }}"
                                    ...
                                    <select name="area_of_work" class="form-select">
                                        ...
                                        @if (!empty($areaOfWork))
                                            @foreach ($areaOfWork as $work)
                                                <option value="{{ $work->name }}" {{ old('area_of_work') == $work->name ? 'selected' : '' }}>
                                                    {{ $work->name }}
                                                </option>
                                            @endforeach
                                        @endif
