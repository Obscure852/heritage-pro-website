        ...
        <div class="col-12">
            <div class="admissions-container">
                <div class="admissions-header">
                    <h4>Edit Sponsor Notification</h4>
                    <p>Update notification details for parents/sponsors</p>
                </div>
                <div class="admissions-body">
                    ...
                    <form class="needs-validation" method="POST"
                        action="{{ route('notifications.update-sponsor-notification', $notification->id) }}"
                                    ...
                                    <select name="filter" class="form-select">
                                        ...
                                        @if (!empty($filters))
                                            @foreach ($filters as $filter)
                                                <option value="{{ $filter->id }}" {{ old('filter', $notification->filter_id) == $filter->id ? 'selected' : '' }}>
                                                    {{ $filter->name }}
                                                </option>
                                            @endforeach
                                        @endif
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function toggleFilters() {
                if (isGeneralCheckbox.checked) {
                    ...
                    const filterSelect = filterElement.querySelector('select[name="filter"]');
                    if (filterSelect) {
                        filterSelect.value = '';
                    }
                } else {
