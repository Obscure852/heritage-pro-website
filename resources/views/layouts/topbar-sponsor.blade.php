        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item bg-soft-light border-start border-end"
                    ...
                    <span class="d-none d-xl-inline-block ms-1 fw-medium">{{ auth('sponsor')->user()->full_name ?? '' }}
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="{{ route('sponsor.profile') }}"><i class="bx bxs-user font-size-16 align-middle me-1"></i>
                        Profile</a>

                    <a class="dropdown-item text-danger" href="{{ route('sponsor.logout') }}"
