...
.eyebrow { display: inline-block; text-transform: uppercase; letter-spacing: 0.12em; font-size: 11px; font-weight: 700; color: var(--brand-indigo-500); }
.eyebrow.muted { color: var(--fg-3); }
h1, h2, h3, h4, h5 { font-family: var(--font-display); letter-spacing: -0.02em; color: var(--fg-1); margin: 0; }
h1 { font-size: 63px; line-height: 1.05; font-weight: 800; }
h2 { font-size: 43px; line-height: 1.1; font-weight: 700; }
h3 { font-size: 27px; line-height: 1.2; font-weight: 700; }
h4 { font-size: 19px; line-height: 1.3; font-weight: 600; }
p  { margin: 0 0 16px; color: var(--fg-2); }
p.lead { font-size: 17px; color: var(--fg-3); line-height: 1.55; }
...
.hero-trust { display: flex; gap: 24px; align-items: center; font-size: 12px; color: var(--fg-3); flex-wrap: wrap; }
.hero-trust b { font-family: var(--font-display); color: var(--fg-1); font-size: 21px; font-weight: 700; display: block; line-height: 1; margin-bottom: 2px; }
...
.hero-media .window-chrome .url {
  flex: 1; margin-left: 18px; font-size: 10px; color: var(--fg-3); font-family: var(--font-mono);
...
.mini-side-brand b { font-family: var(--font-display); font-size: 12px; font-weight: 700; }
.mini-side-brand b span { color: var(--brand-indigo-500); }
.mini-nav-item { display: flex; align-items: center; gap: 8px; padding: 6px 8px; border-radius: 6px; font-size: 10px; color: var(--fg-3); font-weight: 500; }
...
.mini-h { font-size: 15px; font-weight: 700; font-family: var(--font-display); color: var(--fg-1); }
...
.mini-stat b { display: block; font-family: var(--font-display); font-size: 17px; font-weight: 700; }
.mini-stat span { font-size: 9px; color: var(--fg-3); }
.mini-stat .badge { display: inline-block; margin-top: 4px; padding: 2px 6px; font-size: 8px; font-weight: 700; border-radius: 4px; background: var(--success-50); color: var(--success-700); }
.mini-chart {
...
.mini-table { border: 1px solid var(--border-1); border-radius: 10px; background: #fff; padding: 10px 14px; display: flex; flex-direction: column; gap: 6px; font-size: 10px; }
...
.mini-table-row .pill { padding: 2px 6px; font-size: 8px; font-weight: 700; border-radius: 999px; background: var(--success-50); color: var(--success-700); text-align: center; }
...
.mini-table-row code { font-family: var(--font-mono); color: var(--neutral-700); background: var(--neutral-100); padding: 1px 5px; border-radius: 3px; font-size: 9px; }
...
.stats-num { font-family: var(--font-display); font-size: 55px; font-weight: 800; line-height: 1; letter-spacing: -0.02em; margin-bottom: 8px; }
.stats-num span { color: var(--accent-gold-300); }
.stats-label { font-size: 13px; color: rgba(255,255,255,0.7); font-weight: 500; }
...
.product-card p { color: var(--fg-3); font-size: 14px; margin-bottom: 20px; }
.product-card ul { list-style: none; padding: 0; margin: 0 0 24px; display: flex; flex-direction: column; gap: 8px; }
.product-card li {
  position: relative; padding-left: 24px; font-size: 13px; color: var(--fg-2);
}
...
.feature-copy p { color: var(--fg-3); font-size: 15px; line-height: 1.6; margin-bottom: 22px; }
.feature-copy ul { list-style: none; padding: 0; margin: 0 0 28px; display: flex; flex-direction: column; gap: 10px; }
.feature-copy ul li { position: relative; padding-left: 26px; font-size: 13px; color: var(--fg-2); line-height: 1.5; }
...
.testimonial p { font-size: 14px; color: var(--fg-1); line-height: 1.6; flex: 1; }
...
.testimonial .author .avatar { width: 40px; height: 40px; border-radius: 999px; background: var(--brand-gradient); color: #fff; font-weight: 700; display: flex; align-items: center; justify-content: center; font-size: 13px; }
.testimonial .author b { display: block; font-size: 13px; }
.testimonial .author span { font-size: 11px; color: var(--fg-3); }
...
.testimonial .stars { color: var(--accent-gold-500); font-size: 13px; margin-bottom: 12px; letter-spacing: 2px; }
...
.case-body p { color: var(--fg-3); font-size: 13px; flex: 1; }
.case-metrics { display: flex; gap: 20px; margin-top: 16px; padding-top: 16px; border-top: 1px solid var(--border-1); }
.case-metric b { font-family: var(--font-display); font-size: 21px; font-weight: 700; color: var(--brand-indigo-500); display: block; line-height: 1; }
.case-metric span { font-size: 10px; color: var(--fg-3); text-transform: uppercase; letter-spacing: 0.06em; }
...
.price-card .ribbon {
  ...
  background: var(--brand-indigo-500); color: #fff; font-size: 10px; font-weight: 700;
  letter-spacing: 0.06em; text-transform: uppercase; padding: 5px 14px; border-radius: 999px;
}
.price-name { font-family: var(--font-display); font-size: 15px; font-weight: 700; color: var(--brand-indigo-500); margin-bottom: 8px; text-transform: uppercase; letter-spacing: 0.06em; }
.price-amount { font-family: var(--font-display); font-size: 43px; font-weight: 800; color: var(--fg-1); letter-spacing: -0.02em; line-height: 1; }
.price-unit { font-size: 13px; color: var(--fg-3); font-weight: 500; margin-top: 6px; margin-bottom: 20px; }
.price-desc { font-size: 13px; color: var(--fg-2); margin-bottom: 20px; line-height: 1.5; min-height: 60px; }
.price-card ul { list-style: none; padding: 0; margin: 0 0 24px; display: flex; flex-direction: column; gap: 10px; }
.price-card ul li {
  position: relative; padding-left: 26px; font-size: 13px; color: var(--fg-2);
}
...
.faq-q { display: flex; justify-content: space-between; align-items: center; gap: 16px; font-weight: 600; font-size: 14px; color: var(--fg-1); }
...
.faq-a { margin-top: 16px; padding-top: 16px; border-top: 1px solid var(--border-1); color: var(--fg-2); font-size: 13px; line-height: 1.6; }
...
.blog-tag { display: inline-block; font-size: 10px; font-weight: 700; color: var(--brand-indigo-500); text-transform: uppercase; letter-spacing: 0.08em; margin-bottom: 10px; }
.blog-card h4 { margin-bottom: 10px; }
.blog-card p { font-size: 13px; color: var(--fg-3); margin-bottom: 12px; }
.blog-meta { font-size: 11px; color: var(--fg-3); margin-top: auto; }
...
.contact p { color: rgba(255,255,255,0.82); font-size: 16px; margin-bottom: 28px; }
.contact-form {
  background: #fff; border-radius: 20px; padding: 32px; box-shadow: var(--shadow-xl);
}
.form-row { display: grid; grid-template-columns: 1fr 1fr; gap: 14px; }
.form-field { display: flex; flex-direction: column; gap: 6px; margin-bottom: 14px; }
.form-field label { font-size: 11px; font-weight: 600; color: var(--fg-2); }
...
.contact-cta { width: 100%; justify-content: center; padding: 14px; font-size: 14px; }
.contact-list { list-style: none; padding: 0; margin: 32px 0 0; display: flex; flex-direction: column; gap: 14px; }
.contact-list li { display: flex; gap: 14px; align-items: flex-start; color: rgba(255,255,255,0.88); font-size: 13px; }
.contact-list li svg { flex-shrink: 0; color: var(--accent-gold-300); margin-top: 2px; }
.contact-list li b { color: #fff; display: block; margin-bottom: 2px; font-size: 13px; }
...
.logo-strip .label { text-align: center; font-size: 11px; color: var(--fg-3); font-weight: 600; text-transform: uppercase; letter-spacing: 0.12em; margin-bottom: 28px; }
...
.fake-logo .mark {
  ...
  color: #fff; font-weight: 800; font-size: 12px; font-family: var(--font-display);
}
.fake-logo span { font-family: var(--font-display); font-weight: 700; font-size: 14px; color: var(--neutral-700); white-space: nowrap; }
...
.footer-brand p { color: rgba(255,255,255,0.6); font-size: 13px; max-width: 360px; margin-bottom: 20px; }
...
.footer-cols b { display: block; color: #fff; font-weight: 700; font-size: 12px; margin-bottom: 14px; }
.footer-cols a { display: block; color: rgba(255,255,255,0.6); font-size: 12px; padding: 5px 0; }
.footer-cols a:hover { color: #fff; text-decoration: none; }
.footer-bottom { display: flex; justify-content: space-between; align-items: center; padding-top: 28px; font-size: 12px; color: rgba(255,255,255,0.5); }
...
.tweaks-panel h5 { color: #fff; font-size: 13px; margin-bottom: 14px; display: flex; justify-content: space-between; align-items: center; }
.tweaks-panel .close { cursor: pointer; opacity: 0.6; }
.tweaks-panel .close:hover { opacity: 1; }
.tweaks-group { margin-bottom: 18px; }
.tweaks-group > label { display: block; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.08em; color: rgba(255,255,255,0.6); margin-bottom: 8px; }
