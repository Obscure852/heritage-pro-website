    ...
    <div class="row printable">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="text-muted">Staff By Roles</h5>
                    @if (!empty($usersGrouped))
                        @foreach ($usersGrouped as $roleName => $users)
                            <p class="text-muted" style="padding: 10px;font-size:16px;"><strong>{{ $roleName }}</strong>
                            </p>
