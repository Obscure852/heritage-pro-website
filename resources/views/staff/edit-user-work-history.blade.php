...
@section('content')
    ...
    <div class="form-container">
        <div class="page-header">
            <h1 class="page-title">Edit Work History for {{ $user->full_name }}</h1>
        </div>

        <div class="help-text">
            <div class="help-title">Update Work Experience</div>
            <div class="help-content">
                Modify the work history details below. All fields marked with <span class="text-danger">*</span> are required.
            </div>
        </div>

        <form class="needs-validation" method="post" action="{{ route('staff.update-work-history', $work->id) }}" novalidate>
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('workplace') is-invalid @enderror"
                    ...
                    value="{{ old('workplace', $work->workplace ?? '') }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="type_of_work" id="type_of_work" class="form-select @error('type_of_work') is-invalid @enderror" required>
                    ...
                    <option value="Teaching" {{ (old('type_of_work', $work->type_of_work ?? '') == 'Teaching') ? 'selected' : '' }}>Teaching</option>
                    <option value="Non Teaching" {{ (old('type_of_work', $work->type_of_work ?? '') == 'Non Teaching') ? 'selected' : '' }}>Non Teaching</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('role') is-invalid @enderror"
                    ...
                    value="{{ old('role', $work->role ?? '') }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control @error('start') is-invalid @enderror"
                    name="start" id="start" value="{{ old('start', $work->start ?? '') }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control @error('end') is-invalid @enderror"
                    name="end" id="end" value="{{ old('end', $work->end ?? '') }}" required>
            </div>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-primary btn-loading">
                    <span class="btn-text">
                        <i class="fas fa-save me-1"></i> Update Work History
                    </span>
