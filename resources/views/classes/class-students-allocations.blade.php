        ...
        <div class="settings-body">
            <div class="help-text">
                ...
                <div class="help-content">
                    Select students from the list below to allocate them to this class. Use the checkboxes to select multiple students at once.
                    Only students without a class assignment will appear in this list.
                </div>
            </div>

            <form method="POST" action="{{ route('academic.move-students', $class->id) }}" id="allocationForm">
                @csrf
                    ...
                    <div class="col-lg-4 col-md-12 text-lg-end text-md-start mt-lg-0 mt-3">
                        @can('class-allocation-teacher', $class)
                            <button type="submit" class="btn-allocate">
                                <span class="btn-text"><i class="bx bxs-copy-alt"></i> Allocate Selected Students</span>
                ...
                <div class="table-responsive">
                    @if (!empty($students) && count($students) > 0)
                                        ...
                                        <td>
                                            <div class="form-check">
                                                <input type="checkbox" name="students[]" value="{{ $student->id }}"
                                                    class="form-check-input student-checkbox" id="student{{ $student->id }}">
                                            </div>
                                        </td>
                                        <td>
                        ...
                        <div class="pagination-container">
                            <div class="text-muted" id="results-info">
                                Showing <span id="showing-from">0</span> to <span id="showing-to">0</span> of <span id="total-count">{{ count($students) }}</span> students
                            </div>
                    ...
                    @else
                        <div class="empty-state">
                            ...
                            <p>All students have already been allocated to classes, or there are no students in this grade level.</p>
                        </div>
                    @endif
                </div>
            </form>
