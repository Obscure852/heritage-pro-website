...
<head>
    <title>Overall House By Gender</title>
    <style>
        body {
...
<body>
    ...
    <p>Overall House Performance Analysis (By Gender) - {{ $reportPeriod }} - Term {{ $term->term ?? '' }},
        {{ $term->year ?? '' }}</p>
        ...
        <tbody>
            @foreach ($housePerformance as $houseName => $hp)
                ...
                <tr>
                    <td>{{ $houseName }}</td>
                    @foreach (['Merit', 'A', 'B', 'C', 'D', 'E', 'U'] as $grade)
                        <td>{{ $hp['gradeCounts'][$grade]['M'] }}</td>
                        <td>{{ $hp['gradeCounts'][$grade]['F'] }}</td>
                        <td>{{ $hp['gradeCounts'][$grade]['M'] + $hp['gradeCounts'][$grade]['F'] }}</td>
                    @endforeach
