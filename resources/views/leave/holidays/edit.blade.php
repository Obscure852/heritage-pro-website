...
@section('content')
    ...
    <div class="form-container">
        <div class="page-header">
            <h1 class="page-title">Edit Public Holiday</h1>
        </div>

        <div class="help-text">
            <div class="help-title">Update Public Holiday</div>
            <div class="help-content">
                Modify the details of this public holiday. Changes will affect leave calculations for future requests.
                Fields marked with <span class="text-danger">*</span> are required.
            </div>
        </div>

        <form class="needs-validation" method="post" action="{{ route('leave.holidays.update', $holiday->id) }}" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('name', $holiday->name) }}" required maxlength="100">
                    @error('name')
            ...
            <div class="form-grid" style="margin-top: 16px;">
                <div class="form-group full-width">
                    ...
                    <textarea
                        ...
                        maxlength="500">{{ old('description', $holiday->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
