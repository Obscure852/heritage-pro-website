...
@section('content')
    ...
    <div class="form-container">
        <div class="page-header">
            <h1 class="page-title">Edit Leave Type: {{ $leaveType->name }}</h1>
        </div>

        <div class="help-text">
            <div class="help-title">Update Leave Type</div>
            <div class="help-content">
                Modify the leave type settings below. Changes will affect how this leave type is configured for staff requests.
                Fields marked with <span class="text-danger">*</span> are required.
            </div>
        </div>

        <form class="needs-validation" method="post" action="{{ route('leave.types.update', $leaveType) }}" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('code', $leaveType->code) }}" required maxlength="20">
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('name', $leaveType->name) }}" required maxlength="100">
                    @error('name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="text"
                        ...
                        value="{{ old('description', $leaveType->description) }}" maxlength="500">
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="number"
                        ...
                        placeholder="e.g., 21"
                        value="{{ old('default_entitlement', $leaveType->default_entitlement) }}"
                ...
                <div class="form-group">
                    ...
                    <select class="form-select @error('allow_half_day') is-invalid @enderror"
                        ...
                        <option value="1" {{ old('allow_half_day', $leaveType->allow_half_day) == '1' || old('allow_half_day', $leaveType->allow_half_day) === true ? 'selected' : '' }}>Yes</option>
                        <option value="0" {{ old('allow_half_day', $leaveType->allow_half_day) == '0' || old('allow_half_day', $leaveType->allow_half_day) === false ? 'selected' : '' }}>No</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-select @error('allow_negative_balance') is-invalid @enderror"
                        ...
                        <option value="0" {{ old('allow_negative_balance', $leaveType->allow_negative_balance) == '0' || old('allow_negative_balance', $leaveType->allow_negative_balance) === false ? 'selected' : '' }}>No</option>
                        <option value="1" {{ old('allow_negative_balance', $leaveType->allow_negative_balance) == '1' || old('allow_negative_balance', $leaveType->allow_negative_balance) === true ? 'selected' : '' }}>Yes</option>
                    </select>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <select class="form-select @error('gender_restriction') is-invalid @enderror"
                        ...
                        <option value="" {{ old('gender_restriction', $leaveType->gender_restriction) == '' || old('gender_restriction', $leaveType->gender_restriction) === null ? 'selected' : '' }}>No Restriction (All)</option>
                        <option value="male" {{ old('gender_restriction', $leaveType->gender_restriction) == 'male' ? 'selected' : '' }}>Male Only</option>
                        <option value="female" {{ old('gender_restriction', $leaveType->gender_restriction) == 'female' ? 'selected' : '' }}>Female Only</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="number"
                        ...
                        placeholder="e.g., 7"
                        value="{{ old('min_notice_days', $leaveType->min_notice_days) }}"
                        min="0" max="90">
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <select class="form-select @error('requires_attachment') is-invalid @enderror"
                        ...
                        <option value="0" {{ old('requires_attachment', $leaveType->requires_attachment) == '0' || old('requires_attachment', $leaveType->requires_attachment) === false ? 'selected' : '' }}>No</option>
                        <option value="1" {{ old('requires_attachment', $leaveType->requires_attachment) == '1' || old('requires_attachment', $leaveType->requires_attachment) === true ? 'selected' : '' }}>Yes</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="number"
                        ...
                        placeholder="e.g., 3"
                        value="{{ old('attachment_required_after_days', $leaveType->attachment_required_after_days) }}"
                        min="1" max="30">
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <div class="color-input-group">
                        <input type="text"
                            ...
                            maxlength="7"
                            pattern="^#[0-9A-Fa-f]{6}$">
                        <input type="color" class="color-preview" id="color_picker" value="{{ old('color', $leaveType->color) ?: '#3b82f6' }}">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-select @error('is_paid') is-invalid @enderror"
                        ...
                        <option value="1" {{ old('is_paid', $leaveType->is_paid) == '1' || old('is_paid', $leaveType->is_paid) === true ? 'selected' : '' }}>Yes (Paid)</option>
                        <option value="0" {{ old('is_paid', $leaveType->is_paid) == '0' || old('is_paid', $leaveType->is_paid) === false ? 'selected' : '' }}>No (Unpaid)</option>
                    </select>
                    @error('is_paid')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <select class="form-select @error('is_active') is-invalid @enderror"
                        ...
                        <option value="1" {{ old('is_active', $leaveType->is_active) == '1' || old('is_active', $leaveType->is_active) === true ? 'selected' : '' }}>Active</option>
                        <option value="0" {{ old('is_active', $leaveType->is_active) == '0' || old('is_active', $leaveType->is_active) === false ? 'selected' : '' }}>Inactive</option>
                    </select>
                    @error('is_active')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-primary btn-loading">
                    <span class="btn-text"><i class="fas fa-save"></i> Update Leave Type</span>
