        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="report-card">
                    <div class="row">
                        <div class="col-12">
                            <h6>{{ $grade->name ?? '' }} Grade Performance Analysis -
...
<script>
    ...
    gradeDistChart.setOption({
        title: { text: 'Grade Distribution for ' + gradeName + ' by House and Gender', left: 'center' },
    ...
    function updateSubjectChart(subjectName) {
        ...
        subjectChart.setOption({
            title: { text: 'Grade Distribution for ' + subjectName + ' (' + gradeName + ') by Gender', left: 'center' },
