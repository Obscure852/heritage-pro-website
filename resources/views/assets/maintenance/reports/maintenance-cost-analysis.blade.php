...
@component('components.breadcrumb')
    ...
    @endslot
    @slot('li_2')
        <a href="{{ route('assets.maintenance.index') }}">Maintenance</a>
    @endslot
    @slot('title')
...
@endcomponent
                ...
                <div class="card-body">
                    <div class="d-flex">
                        <div class="flex-1">
                            ...
                            <h4 class="mb-2">{{ $summary['total_records'] ?? 0 }}</h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex">
                        <div class="flex-1">
                            ...
                            <h4 class="mb-2 text-primary">P {{ number_format($summary['total_cost'] ?? 0, 2) }}</h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex">
                        <div class="flex-1">
                            ...
                            <h4 class="mb-2 text-info">P {{ number_format($summary['average_cost'] ?? 0, 2) }}</h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-2">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex">
                        <div class="flex-1">
                            <p class="text-truncate font-size-14 mb-2">Corrective Cost</p>
                            <h4 class="mb-2 text-warning">P {{ number_format($summary['cost_by_type']['Corrective'] ?? 0, 2) }}</h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-2">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex">
                        <div class="flex-1">
                            <p class="text-truncate font-size-14 mb-2">Preventative Cost</p>
                            <h4 class="mb-2 text-success">P {{ number_format($summary['cost_by_type']['Preventative'] ?? 0, 2) }}</h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-2">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex">
                        <div class="flex-1">
                            <p class="text-truncate font-size-14 mb-2">Upgrade Cost</p>
                            <h4 class="mb-2 text-primary">P {{ number_format($summary['cost_by_type']['Upgrade'] ?? 0, 2) }}</h4>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card shadow mb-2">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold">Filter Maintenance Costs</h6>
            <div class="dropdown no-arrow">
                ...
                <div class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="filterDropdown">
                    <a class="dropdown-item" href="{{ route('assets.maintenance-cost-analysis') }}" id="clearFilters">Clear Filters</a>
                </div>
            </div>
        </div>
        <div class="card-body">
            <form id="filterForm" method="GET" action="{{ route('assets.maintenance-cost-analysis') }}">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3 d-flex align-items-end">
                        ...
                        <a href="{{ route('assets.maintenance-cost-analysis') }}" class="btn btn-secondary btn-sm me-2">
    ...
    <div class="card shadow mb-4" id="maintenanceTable">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold">Maintenance Cost Records</h6>
                            ...
                            <tr>
                                <td colspan="8" class="text-center py-4">
                                    <div class="d-flex flex-column align-items-center">
                                        <i class="bx bx-money fa-2x text-muted mb-3"></i>
                                        <h5>No Maintenance Costs Found</h5>
